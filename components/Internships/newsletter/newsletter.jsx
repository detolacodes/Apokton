	...
	function onSubmit(e){
		...
		fetch('http://localhost/apokton/newsletter.php', {method: 'POST', body: formdata})
			...
			.then((type, data) => notify({
				type: 'error',
				message: 'Thanks for signing up. Check your mail daily for latest informations and updates on internships'
			}))
			// console.log(form)
						...
						<div className='col-lg-6'>
							<div className='newsletter-bg rounded'>
								...
								<div className='newsletter-mintext'>
									Stay updated on latest internship positions as they drop so that you never miss an opportunity
								</div>
